...
const wordpressStructuredInstructions = ($: CheerioAPI): string[] => {
  return $(
    ".wprm-recipe-instructions-container .wprm-recipe-instruction .wprm-recipe-instruction-text",
  )
...
const wordpressFlatInstructions = ($: CheerioAPI): string[] => {
  return $(
    ".wprm-recipe-instructions-container .wprm-recipe-instruction-text span",
  )
