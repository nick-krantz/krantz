 ...
 */
export const addIdToIngredients = (ingredients: IngredientsWithSections[]): ScraperRecipeWithIds['ingredients'] => {
 ...
 */
export const addIdToInstructions = (instructions: string[]): ScraperRecipeWithIds['instructions'] => {
