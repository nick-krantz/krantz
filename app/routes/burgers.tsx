  ...
  return (
    <div className="flex flex-col max-w-2xl mx-auto gap-8 w-full">
      <p className="text-center">
        I've thought more than once that I've had the best burger, so I started to track all of them. Why put it online?
        Because version control is cool and this is far more easier to maintain than a piece of paper.
      </p>
      {!!burgers && (
        <motion.ol
