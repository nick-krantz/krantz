...
export const Logo: React.FC = () => {
  return (
    <svg className="w-full max-w-2xl" viewBox="-1 -19.604 454 168.988" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <motion.path variants={fillVariants} {...pathProps(5)} d="M 15.481 51.742 L 1.986 64.875 L 15.43 78.104" />
      <motion.path
        variants={outlineVariants}
        {...pathProps(1.5)}
      ...
      />
      <motion.path variants={fillVariants} {...pathProps(5)} d="M 45.271 51.646 L 58.664 64.875 L 45.22 78.2" />
      <motion.path
        style={{
          fill: 'currentcolor',
        }}
      ...
      />
      <motion.path variants={fillVariants} {...pathProps(5)} d="M 397.689 51.679 L 384.23 64.888 L 397.737 78.278" />
      ...
      />
      <motion.path variants={fillVariants} {...pathProps(5)} d="M 424.703 46.539 L 410.813 83.328" />
      <motion.path
        variants={outlineVariants}
        {...pathProps(1.5)}
      ...
      />
      <motion.path variants={fillVariants} {...pathProps(5)} d="M 435.527 51.453 L 448.987 64.843 L 435.624 78.323" />
    </svg>
  )
}
